...
VIP.auth = (function () {
    ...
    function renderRefundsHomeUI() {
        ...
        // El número se renderiza como botón clickeable que abre WhatsApp.
        // wa.me requiere el número sin el "+" y sin separadores.
        ...
        const waIcon =
            ...
            '</svg>';
        // Mostramos "CARGUE AQUI" en lugar del numero — el numero sigue usandose
        // en el href de wa.me y en el aria-label, pero no se renderiza visualmente.
        phoneEl.innerHTML =
            '<a href="https://wa.me/' + waNumber + '" target="_blank" rel="noopener noreferrer" ' +
              'aria-label="Abrir WhatsApp con el número ' + safePhone + '">' +
                waIcon +
                '<span>CARGUE AQUI</span>' +
            '</a>';
    }
